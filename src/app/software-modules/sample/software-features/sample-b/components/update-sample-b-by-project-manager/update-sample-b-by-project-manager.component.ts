...
import {
  UpdateSampleBByProjectManagerPlant,
  UpdateSampleBByProjectManagerSeedsCommand,
  UpdateSampleBByProjectManagerFruitSeeds,
  UpdateSampleBByProjectManagerService
} from '../../services/update-sample-b-by-project-manager.service';
import {SelectEnum} from '../../../../../../core/domain/select-enum';
import {SelectEntity} from '../../../../../../core/domain/select-entity';

@Component({
  selector: 'app-update-sample-b-by-project-manager',
  templateUrl: './update-sample-b-by-project-manager.component.html',
  styleUrls: ['./update-sample-b-by-project-manager.component.css']
})
export class UpdateSampleBByProjectManagerComponent implements OnInit {
  entityId: number;
  readyToUpdate = false;
  loading = false;
  ...
  constructor(private useCase: UpdateSampleBByProjectManagerService,
              private dialogService: UtilityDialogService,
              private localeService: LocaleService,
              private dateService: UtilityDateService,
              public dialogRef: MatDialogRef<UpdateSampleBByProjectManagerComponent>,
  ...
  init(fruitSeeds: UpdateSampleBByProjectManagerFruitSeeds): void {
  ...
  private cultivate(): void {
    ...
    this.useCase
      .cultivate(new UseCaseCommand<UpdateSampleBByProjectManagerPlant>(
        new UpdateSampleBByProjectManagerPlant(
          idInput,
          nameInput,
          activeInput,
          createDateInput,
  ...
  private prepare(): void {
    this.useCase
      .prepare(new UseCaseSeedsCommand<UpdateSampleBByProjectManagerSeedsCommand>(
        new UpdateSampleBByProjectManagerSeedsCommand(this.entityId),
        this.localeService.getLocale().getValue()
      ))
