...
import {
  UpdateSoftwareByProjectManagerPlant,
  UpdateSoftwareByProjectManagerSeedsCommand,
  UpdateSoftwareByProjectManagerFruitSeeds,
  UpdateSoftwareByProjectManagerService
} from '../../services/update-software-by-project-manager.service';
import {SelectEnum} from '../../../../../../core/domain/select-enum';
import {SelectEntity} from '../../../../../../core/domain/select-entity';

@Component({
  selector: 'app-update-software-by-project-manager',
  templateUrl: './update-software-by-project-manager.component.html',
  styleUrls: ['./update-software-by-project-manager.component.css']
})
export class UpdateSoftwareByProjectManagerComponent implements OnInit {
  entityId: number;
  readyToUpdate = false;
  loading = false;
  ...
  constructor(private useCase: UpdateSoftwareByProjectManagerService,
              private dialogService: UtilityDialogService,
              private localeService: LocaleService,
              private dateService: UtilityDateService,
              public dialogRef: MatDialogRef<UpdateSoftwareByProjectManagerComponent>,
  ...
  init(fruitSeeds: UpdateSoftwareByProjectManagerFruitSeeds): void {
  ...
  private cultivate(): void {
    ...
    this.useCase
      .cultivate(new UseCaseCommand<UpdateSoftwareByProjectManagerPlant>(
        new UpdateSoftwareByProjectManagerPlant(
          idInput,
          softwareNameInput,
          softwareTitleInput,
  ...
  private prepare(): void {
    this.useCase
      .prepare(new UseCaseSeedsCommand<UpdateSoftwareByProjectManagerSeedsCommand>(
        new UpdateSoftwareByProjectManagerSeedsCommand(this.entityId),
        this.localeService.getLocale().getValue()
      ))
