...
export class UpdateUseCaseDataAttributeByProjectManagerComponent implements OnInit {
  ...
  init(fruitSeeds: UpdateUseCaseDataAttributeByProjectManagerFruitSeeds): void {
    ...
    this.reactiveForm = new FormGroup({
      ...
      setterOfUpdatePath: new FormControl(setterOfUpdatePathFruitSeeds, [Validators.nullValidator, Validators.required]),
      getterOfUpdatePath: new FormControl(getterOfUpdatePathFruitSeeds, [Validators.nullValidator, Validators.required]),
