...
import {
  AddNewUseCaseByProjectManagerPlant,
  AddNewUseCaseByProjectManagerSeedsCommand,
  AddNewUseCaseByProjectManagerFruitSeeds,
  AddNewUseCaseByProjectManagerService
} from '../../services/add-new-use-case-by-project-manager.service';
import {SelectEnum} from '../../../../../../core/domain/select-enum';
import {SelectEntity} from '../../../../../../core/domain/select-entity';

@Component({
  selector: 'app-add-new-use-case-by-project-manager',
  templateUrl: './add-new-use-case-by-project-manager.component.html',
  styleUrls: ['./add-new-use-case-by-project-manager.component.css']
})
export class AddNewUseCaseByProjectManagerComponent implements OnInit {
  entityId: number;
  readyToUpdate = false;
  loading = false;
  ...
  constructor(private useCase: AddNewUseCaseByProjectManagerService,
              ...
              public dialogRef: MatDialogRef<AddNewUseCaseByProjectManagerComponent>,
  ...
  init(fruitSeeds: AddNewUseCaseByProjectManagerFruitSeeds): void {
  ...
  private prepare(): void {
    this.useCase
      .prepare(new UseCaseSeedsCommand<AddNewUseCaseByProjectManagerSeedsCommand>(
        new AddNewUseCaseByProjectManagerSeedsCommand(this.entityId),
        this.localeService.getLocale().getValue()
      ))
